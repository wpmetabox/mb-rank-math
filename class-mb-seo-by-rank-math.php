...
class MB_SEO_BY_RANK_MATH {
	...
	public function enqueue( RW_Meta_Box $meta_box) {
		...
		wp_enqueue_script( 'mb-seo-by-rank-math', $url . 'script.js', array( 'jquery', 'wp-hooks', 'rank-math-analyzer' ), '1.3.1', true );

		// Send list of fields to JavaScript.
		wp_localize_script( 'mb-seo-by-rank-math', 'MBSEOByRankMath', $this->fields );
	}
